...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libprotobuf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libprotobuf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libprotobuf libprotobuf-python-headers libprotobuf-static
# for installing globally
pixi global install libprotobuf libprotobuf-python-headers libprotobuf-static
```
...
It is possible to list all of the versions of `libprotobuf` available on your platform:
...
```
pixi search libprotobuf --channel conda-forge
```
